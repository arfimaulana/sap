<?php 
	...
	if (mysqli_connect_errno()){
		...
		// 			WHERE scan_time BETWEEN '".$new." 10:00:00' AND '".$new." 23:59:59' AND io IN ('0','1') AND sys_users.`role_id` = '6'
		// 			GROUP BY user_id ORDER BY sys_data_scan.`id` ASC";
		$mysql = "SELECT u.nama AS ID, u.nik AS f01, 
					...
					WHERE a.scan_date BETWEEN '".$new." 10:00:00' AND '".$new." 23:59:59' AND g.io IN ('0','1') AND u.role_id = '6'
					GROUP BY a.pin";
