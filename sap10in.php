<?php 
	...
	if (mysqli_connect_errno()){
		...
		// 			WHERE scan_time BETWEEN '".$date." 00:00:00' AND '".$date." 09:59:59' AND io = '1' AND sys_users.`role_id` = '6'
		...
		$mysql = "SELECT u.nama AS ID, 
					...
					WHERE a.scan_date BETWEEN '".$date." 00:00:00' AND '".$date." 09:59:59' AND g.io = '1' AND u.role_id = '6'
					GROUP BY a.pin";
